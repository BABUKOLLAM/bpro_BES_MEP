...
class HrPayslip(models.Model):
    ...
    def bpro_ot_amount(self, employee, contract):
        ...
        multiplier. Ordinary rate = UNPRORATED contracted monthly gross
        / (26 x 8) - the statutory divisor convention; an employee's
        ordinary rate of wages doesn't shrink because they were absent
        (LOP) on other days of the month."""
        self.ensure_one()
